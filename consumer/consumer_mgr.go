...
func DefaultConsumerReceive(fn func(string, []byte, *sarama.ConsumerMessage)) (err error) {
...
func Receive(name string, fn func(string, []byte, *sarama.ConsumerMessage)) (err error) {
